...
import com.sanctionco.template.SampleConfiguration;
...
class OpenApiBundleTest {
  ...
  private static final Bootstrap<SampleConfiguration> bootstrap = mock(Bootstrap.class);
  ...
  @SuppressWarnings("unchecked")
  void testInitialize() {
    OpenApiBundle<SampleConfiguration> bundle = new OpenApiBundle<SampleConfiguration>() {
      @Override
